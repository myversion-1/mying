// ko.ts translations for next-intl
// Converted from mying-web\src\content\locales\ko.ts
...
export default {
  ...
  aboutPage: {
    manufacturingCapabilities: {
      title: "제조 능력",
      subtitle: "엄격한 품질 관리와 국제 표준 준수를 갖춘 최첨단 생산 시설.",
      items: [
        "고급 제조 장비 및 정밀 엔지니어링",
        "생산의 모든 단계에서 포괄적인 품질 보증",
        "소규모부터 대규모 주문까지 확장 가능한 생산 능력",
        "맞춤형 설계 및 엔지니어링 서비스",
        "국제 안전 표준의 엄격한 준수",
        "효율적인 공급망 및 물류 관리",
      ],
    ...
    certifications: {
      title: "업계 인증 및 규정 준수",
      subtitle: "품질과 안전에 대한 우리의 약속은 국제 인증 및 표준으로 검증되었습니다.",
    },
    patents: {
      title: "특허 증명서",
    ...
    factoryTour: {
      title: "공장 견학",
      subtitle: "우리의 제조 공정을 직접 보세요. 생산 시설과 품질 관리 시스템을 직접 경험하세요.",
      videoTitle: "가상 공장 견학",
      galleryTitle: "생산 라인 갤러리",
      ctaText: "공장 견학 예약",
    },
    partnership: {
      title: "장기 파트너십 구축",
      subtitle: "우리는 단순히 놀이기구를 제공하는 것이 아니라 신뢰성, 투명성 및 지속적인 지원을 통해 고객과 지속적인 관계를 구축합니다.",
      items: [
        "원활한 커뮤니케이션을 위한 전담 계정 관리",
        "장기 부품 공급 및 기술 지원",
        "정기적인 품질 감사 및 성능 검토",
        "비즈니스 요구에 맞춘 유연한 솔루션",
        "숨겨진 비용 없는 투명한 가격 책정",
        "정시 배송 및 고객 만족도 검증된 실적",
      ],
    },
  },
  customerService: {
