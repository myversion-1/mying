...
export const id: CopyContent = {
  ...
  footer: {
    ...
    companyName: "Peralatan Hiburan Miying",
    tagline: "Produsen peralatan hiburan yang dapat diandalkan untuk pusat hiburan keluarga dan taman hiburan di seluruh dunia.",
    contact: {
      title: "Hubungi Kami",
      email: "miyingyoule@gmail.com",
      phone: "+86-131-1295-9561",
      address: "China",
      workingHours: "Sen-Jum: 9:00 - 18:00 (GMT+8)",
    },
    quickLinks: {
      title: "Tautan Cepat",
      products: "Produk",
    ...
    socialMedia: {
      title: "Ikuti Kami",
      followUs: "Tetap terhubung dengan kami di media sosial",
      email: "Email",
      tiktok: "TikTok",
      youtube: "YouTube",
      whatsapp: "WhatsApp",
    ...
    newsletter: {
      title: "Tetap Diperbarui",
      subtitle: "Dapatkan pembaruan terbaru tentang produk baru dan wawasan industri",
