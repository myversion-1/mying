...
export const vi: CopyContent = {
  nav: {
    ...
    "trade-shows": "Triển lãm thương mại",
    contact: "Liên hệ",
  ...
  footer: {
    ...
    companyName: "Thiết bị giải trí Miying",
    tagline: "Nhà sản xuất thiết bị giải trí đáng tin cậy cho trung tâm giải trí gia đình và công viên giải trí trên toàn thế giới.",
    contact: {
      title: "Liên hệ với chúng tôi",
      email: "miyingyoule@gmail.com",
      phone: "+86-131-1295-9561",
      address: "Trung Quốc",
      workingHours: "Thứ 2 - Thứ 6: 9:00 - 18:00 (GMT+8)",
    },
    quickLinks: {
    ...
    socialMedia: {
      ...
      followUs: "Kết nối với chúng tôi trên mạng xã hội",
      email: "Email",
      tiktok: "TikTok",
      youtube: "YouTube",
      whatsapp: "WhatsApp",
    ...
    newsletter: {
      ...
      subtitle: "Nhận thông tin cập nhật mới nhất về sản phẩm mới và thông tin ngành",
