...
export const ja: CopyContent = {
  ...
  footer: {
    ...
    companyName: "Miying アトラクション設備",
    tagline: "世界中のファミリーエンターテインメントセンターとテーマパーク向けの信頼できるアトラクション設備メーカー。",
    contact: {
      title: "お問い合わせ",
      email: "miyingyoule@gmail.com",
      phone: "+86-131-1295-9561",
      address: "中国",
      workingHours: "月〜金: 9:00 - 18:00 (GMT+8)",
    },
    quickLinks: {
      title: "クイックリンク",
      products: "製品",
    ...
    socialMedia: {
      title: "フォローする",
      followUs: "ソーシャルメディアで私たちとつながりましょう",
      email: "メール",
      tiktok: "TikTok",
      youtube: "YouTube",
      whatsapp: "WhatsApp",
    ...
    newsletter: {
      title: "最新情報を受け取る",
      subtitle: "新製品と業界のインサイトに関する最新情報を入手",
