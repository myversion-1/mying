...
export const ko: CopyContent = {
  ...
  footer: {
    ...
    companyName: "Miying 놀이기구 장비",
    tagline: "전 세계 가족 엔터테인먼트 센터 및 테마파크를 위한 신뢰할 수 있는 놀이기구 장비 제조업체.",
    contact: {
      title: "문의하기",
      email: "miyingyoule@gmail.com",
      phone: "+86-131-1295-9561",
      address: "중국",
      workingHours: "월-금: 오전 9:00 - 오후 6:00 (GMT+8)",
    },
    quickLinks: {
      title: "빠른 링크",
      products: "제품",
    ...
    newsletter: {
      title: "최신 정보 받기",
      subtitle: "신제품 및 업계 인사이트에 대한 최신 업데이트 받기",
