...
export const es: CopyContent = {
  ...
  footer: {
    ...
    companyName: "Equipos de Entretenimiento Miying",
    tagline: "Fabricante confiable de equipos de entretenimiento para centros de entretenimiento familiar y parques temáticos en todo el mundo.",
    contact: {
      title: "Contáctenos",
      email: "miyingyoule@gmail.com",
      phone: "+86-131-1295-9561",
      address: "China",
      workingHours: "Lun-Vie: 9:00 AM - 6:00 PM (GMT+8)",
    },
    quickLinks: {
    ...
    socialMedia: {
      title: "Síguenos",
      followUs: "Mantente conectado con nosotros en las redes sociales",
    ...
    newsletter: {
      ...
      subtitle: "Obtén las últimas actualizaciones sobre nuevos productos e información de la industria",
