  ...
  return (
    <div className="spatial-audit-form my-12 rounded-2xl border border-[var(--border)] bg-[var(--surface-elevated)] p-8 md:p-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          className="w-full rounded-lg bg-[var(--action-primary)] px-8 py-4 font-semibold text-[var(--action-primary-text)] !text-[var(--action-primary-text)] transition-colors hover:bg-[var(--action-primary-hover)] min-h-[44px] touch-manipulation"
        >
